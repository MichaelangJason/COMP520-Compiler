...
la $t0,label_46_v8
sw $t4,0($t0)
# Original instruction: addiu v8,v8,20
la $t4,label_46_v8
lw $t4,0($t4)
addiu $t4,$t4,20
la $t0,label_46_v8
...
la $t0,label_120_v29
sw $t5,0($t0)
# Original instruction: addiu v29,v29,16
la $t4,label_120_v29
lw $t4,0($t4)
addiu $t4,$t4,16
la $t0,label_120_v29
...
la $t0,label_127_v34
sw $t5,0($t0)
# Original instruction: addiu v34,v34,20
la $t4,label_127_v34
lw $t4,0($t4)
addiu $t4,$t4,20
la $t0,label_127_v34
...
# >>>Assign<<<: INT
# >>Get VAR Addr<<
# Original instruction: lw v35,12($fp)
lw $t5,12($fp)
la $t0,label_135_v35
sw $t5,0($t0)
# Original instruction: addiu v35,v35,4
la $t4,label_135_v35
lw $t4,0($t4)
addiu $t4,$t4,4
la $t0,label_135_v35
...
sw $t4,0($t0)
# >>>Copy Value<<<
# Original instruction: sw v38,4($fp)
la $t5,label_139_v38
lw $t5,0($t5)
sw $t5,4($fp)
# >>>Returned<<<
